...
def-env activate-virtualenv [] {
    ...
    let virtual_env = '/Users/reshmaraghavan/Solo_Projects/Server/venv'
    let bin = 'bin'
    let path_sep = ':'
...
alias deactivate = source '/Users/reshmaraghavan/Solo_Projects/Server/venv/bin/deactivate.nu'
